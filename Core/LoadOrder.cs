...
{
    /// <summary>
    /// Вспомогательный атрибут, указывающий на то, что объект текущего тип должен быть загружен перед другими заданными объектами перечисленных типов.
    ...
    /// <summary>
    /// Вспомогательный атрибут, указывающий на то, что объект текущего тип должен быть загружен после других заданных объектов перечисленных типов.
    ...
    /// <summary>
    /// Вспомогательный атрибут, указывающий на то, что объект текущего тип должен быть загружен между двумя другими объектами перечисленных типов.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Interface, AllowMultiple = true, Inherited = true)]
