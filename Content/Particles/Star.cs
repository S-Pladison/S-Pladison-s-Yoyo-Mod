...
{
    public sealed class StarParticle : BaseParticle
    {
        public static readonly LazyAsset<Texture2D> Texture = LazyAsset<Texture2D>.From($"{nameof(SPYoyoMod)}/Assets/Particles/{nameof(StarParticle)}");
