...
namespace SPYoyoMod.Content.Items.Vanilla.Yoyos
{
    ...
    public sealed class ArteryProjectile : VanillaYoyoBaseProjectile, IInitializableProjectile
    {
        public static readonly Color GlowColor = new(0, 0, 0);
        ...
        void IInitializableProjectile.Initialize(Projectile _)
        {
            ...
            _stringRenderer = new YoyoStringRenderer(new IDrawYoyoStringSegments.Gradient(
               ModContent.Request<Texture2D>(ArteryAssets.StringPath, AssetRequestMode.ImmediateLoad).Value,
        ...
        public override bool PreDraw(Projectile proj, ref Color lightColor)
        {
            ...
            var glowTexture = ArteryAssets.GlowTexture.Value;
